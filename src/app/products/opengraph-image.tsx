...
export const alt = "Brooeggs Products — Country Chicken Eggs in Retail, Tray & Bulk Packs";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <div style={{ display: "flex", gap: 12, fontSize: 64, lineHeight: 1 }}>
          ...
          <div style={{ fontSize: 26, color: "rgba(255,255,255,0.80)", fontFamily: "Arial, sans-serif", textAlign: "center", maxWidth: 700 }}>
            6-pack · 12-pack · 30 Tray · 90 Half Case · 180 Bulk Case · Wholesale
          </div>
