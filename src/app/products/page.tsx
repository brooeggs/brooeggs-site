  ...
  itemListElement: [
    {
      ...
      item: {
        ...
        image: "https://brooeggs.in/images/6_eggs.jpeg",
        url: "https://brooeggs.in/products",
    ...
    },
    {
      ...
      item: {
        ...
        brand: { "@type": "Brand", name: "Brooeggs" },
        image: "https://brooeggs.in/images/15_eggs.jpeg",
        url: "https://brooeggs.in/products",
        aggregateRating: PRODUCT_RATING,
      },
    },
    ...
    },
    {
      ...
      item: {
        ...
        brand: { "@type": "Brand", name: "Brooeggs" },
        image: "https://brooeggs.in/images/bulk_eggs.jpeg",
        url: "https://brooeggs.in/products",
        aggregateRating: PRODUCT_RATING,
      },
    },
...
const products = [
  { img: "/images/6_eggs.jpeg", name: "Starter Pack — 6 Eggs",    desc: "Perfect for individuals, couples, or anyone trying Brooeggs for the first time. Sealed fresh, compact, and easy to carry.", features: ["6 premium country eggs","Hygiene-sealed pack","Great for first-time buyers","Same-day fresh"], cta: "Order Now", ctaClass: "btn-outline-gold", featured: false, badge: null },
