...
export const metadata: Metadata = {
  ...
  description: "Brooeggs Instagram page coming soon.",
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-cream-dark via-cream to-cream-deep relative overflow-hidden">
      ...
      <div className="text-center relative z-[2] px-7 py-16 max-w-[520px]">
        ...
        <h1 className="font-heading font-[800] text-[2.2rem] text-dark mb-3">Instagram <em className="italic text-gold-dark">Coming Soon</em></h1>
        <p className="text-text-mid text-[1rem] leading-[1.75] mb-8">Fresh photos, farm moments, and egg recipes coming to Instagram soon. Stay tuned for our launch!</p>
